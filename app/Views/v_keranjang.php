                ...
                <div class="card mb-4 shadow-sm rounded p-3 d-flex flex-row">
                    ...
                    <div class="ms-4 flex-grow-1">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <input type="number" min="1" name="qty<?= $i ?>" id="qty<?= $i ?>" class="form-control text-center" style="width: 60px;" value="<?= $item['qty'] ?>">
                            <button type="button" class="btn btn-outline-dark btn-sm rounded-circle" onclick="changeQty('qty<?= $i ?>', 1)">
                        ...
                        <a href="<?= base_url('keranjang/delete/' . $item['rowid']) ?>" class="btn btn-dark btn-sm rounded-pill mt-2">
